...
const Recipe = () => {
    ...
    <div class="video-receita1">
        <div>
            <iframe width="698" height="389" src="https://www.youtube.com/embed/7EnWiGYT1g4?si=KeAZjPDFZafbRyf6"
                title="YouTube video player" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowfullscreen class="video-video"></iframe>
        </div>
        <div class="video-texto">
            <h2>Vídeo com receita</h2>
            <p>Don’t let plankton know we’ve cracked the recipe.</p>
            <p><span class="material-symbols-outlined">Timer</span> 40 min. <span
                    class="material-symbols-outlined">restaurant</span> 2 Portions</p>
        </div>
    </div>
    <div class="video-receita2">
        <div class="video-texto2">
            <h2>The Lore</h2>
